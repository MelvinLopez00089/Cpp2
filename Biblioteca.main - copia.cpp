...
void cargarLibros() {
	...
	libros[13][0] = "Metodologias de desarrollo de software"; libros[13][1] = "Compendio de Ingenieria del Software"; libros[13][2] = "Melvin Lopez" ;
	...
	libros[17][0] = "Metodologias de desarrollo de software"; libros[17][1] = "Scrum y XP desde las trincheras"; libros[17][2] = "Porfirio Lobo" ;
	...
	libros[30][0] = "Python"; libros[30][1] = "Doma de Serpientes para Ninos: Aprendiendo a Programar con Python"; libros[30][2] = "Juan Manuel" ;
	...
	libros[38][0] = "Python"; libros[38][1] = "Python para todos"; libros[38][2] = " R Martin" ;
}
